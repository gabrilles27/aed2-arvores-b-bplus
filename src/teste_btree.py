import BTree, time, tracemalloc, random

def criar_arvore_b_indices(path, grau_t):
    arvore = BTree.BTree(grau_t)
    with open(path, 'r', encoding='utf-8') as f:
        ...
        while True:
            ...
            arvore.insert((int(id_str), offset))
    return arvore
...
def inserir_novo_registro(arvore, path, id_novo, linha_completa, tipo_arvore="B"):
    ...
    # inicia o cronometro apenas na inserção na arvore
...
if __name__ == "__main__":
    ...
    arvore = criar_arvore_b_indices(path, grau)
    ...
    while True:
        ...
        match opcao:
            ...
            case 3:
                ...
                arvore.delete(arvore.root, (isbn_remover,))
            ...
            case 4:
                ...
                sugestao_fim = sugestao_inicio + 100  # Range padrão de 100 registros
                ...
                for isbn in range(isbn_inicio, isbn_fim + 1):
                    arvore.delete(arvore.root, (isbn,))
            ...
            case 5:
                ...
                offset_encontrado = arvore.search(arvore.root, isbn_procurado)
            ...
            case 6:
                ...
                lista_offsets = arvore.range_search(arvore.root, isbn_inicio, isbn_fim)
